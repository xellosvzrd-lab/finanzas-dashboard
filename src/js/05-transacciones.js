...
function duplicarTransaccion(id) {
  ...
  setTimeout(() => {
    ...
    document.getElementById("f-monto").value       = String(Math.abs(Number(t.monto))).replace('.', ',');
...
function abrirEditorTransaccion(id) {
  ...
  document.getElementById("edit-monto").value           = String(Math.abs(Number(t.monto))).replace('.', ',');
